...
/**
 * the orders class represent the orders in the DB
 */
public class Orders implements Serializable {
	 ...
	 * @param typeOrder   the type order of the order {'individual', 'small group',
	 *                    'organized group'}
	 ...
	 */
	public Orders(String orderID, String parkName, String visitTime, String visitorsNum, String email, String address,
			String typeOrder, String visitorID, String year, String month, String day) {
	...
	/**
	 * another constructor if we don't have day month year
	 * 
	 * @param orderID     the ID of the order
	 * @param parkName    the park name of the order
	 * @param date        the date of the order
	 ...
	 */
	public Orders(String orderID, String parkName, String visitTime, String visitorsNum, String email, String address,
			String typeOrder, String visitorID) {
		this.orderID = orderID;
		this.parkName = parkName;
		this.visitTime = visitTime;
		this.visitorsNum = visitorsNum;
